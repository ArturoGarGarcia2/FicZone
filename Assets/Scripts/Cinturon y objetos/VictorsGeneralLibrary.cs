...
namespace VicGenLib
{
    namespace Calc
    {
        ...
        public class Angles
        {
            ...
            public static float3 NormalToEulerAnglesf3(float rotacionX, float rotacionY, float rotacionZ)
            {
                float3 rotacionNueva = new Vector3(rotacionX / 57.295645530939648586707410236822f,
                                                            rotacionY / 57.295645530939648586707410236822f, 
                                                            rotacionZ / 57.295645530939648586707410236822f);
